...
int shadow_on = 0;
// a flag to indicate whether you want to have reflections
int reflection_on = 0;
// a flag to indicate whether you want to have the chess board
int chess_board_on = 0;
// a flag to indicate whether you want to have refraction
int refraction_on = 0;
// a flag to indicate whether you want to have stochastic rays
int stochastic_on = 0;
// a flag to indicate whether you want to have supersampling
